...
public class Master {
	...
	public String toString() {
		return "Master [code=" + code + ", sector=" + sector + ", plotNo=" + plotNo + "]";
	}

	public boolean validate() {
		boolean flage = false;
		if (this.areaType == null || this.areaType.length() <= 0 || this.plotNo == null || this.plotNo.length() <= 0
				|| this.code == null || this.code.length() <= 0 || this.sector == null || this.sector.length() <= 0) {
