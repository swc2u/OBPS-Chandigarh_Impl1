...
(nextval('seq_eg_module'),'BPA Plinth Level Certificate',true,'bpa',(select id from chandigarh.eg_module where "name" = 'BPA Transanctions'),'Plinth Level Certificate',1)
;
...
(nextval('seq_egp_portalservice'),(select id from chandigarh.eg_module where "name" = 'BPA'),'Apply For Plinth Level Certificate',NULL,0,'/bpa/application/citizen/pl-certificate/apply',true,'Apply For Plinth Level Certificate',false,true,'/bpa/application/citizen/pl-certificate/apply',1,now(),now(),1,16,NULL)
;
...
(nextval('seq_eg_action'),'Apply For Plinth Level Certificate','/application/citizen/pl-certificate/apply',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Apply For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'New Application For Plinth Level Certificate','/application/citizen/pl-certificate/new',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'New Application For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Submit Application For Plinth Level Certificate','/application/citizen/pl-certificate/create',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Submit Application For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'View Application For Plinth Level Certificate','/application/citizen/plinth-level-certificate/update',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'View Application For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
(nextval('seq_eg_wf_types'),(select id from eg_module where "name" = 'BPA'),'PlinthLevelCertificate','/bpa/application/plinth-level-certificate/update/:ID',1,now(),1,now(),true,false,'org.egov.bpa.transaction.entity.pl.PlinthLevelCertificate','Plinth Level Certificate',0);
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Success Application For Plinth Level Certificate','/application/plinth-level-certificate/success',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Success Application For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Update Application For Plinth Level Certificate','/application/plinth-level-certificate/update',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Update Application For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Update Submit Application For Plinth Level Certificate','/application/plinth-level-certificate/update-submit',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Update Submit Application For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Generate Plinth Level Certificate','/application/plinth-level-certificate/generate-plinth-level-certificate',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Generate Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Schedule Appointment Plinth Level Certificate','/application/plinth-level-certificate/schedule-appointment',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Schedule Appointment Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Reschedule Appointment Plinth Level Certificate','/application/plinth-level-certificate/reschedule-appointment',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Reschedule Appointment Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'View Appointment Plinth Level Certificate','/application/plinth-level-certificate/appointment/view-details',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'View Appointment Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Create Inspection For Plinth Level Certificate','/application/plinth-level-certificate/create-inspection',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Create Inspection For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Result Inspection For Plinth Level Certificate','/application/plinth-level-certificate/success/view-inspection-details',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Result Inspection For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Show Inspection For Plinth Level Certificate','/application/plinth-level-certificate/show-inspection-details',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Show Inspection For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Update Inspection For Plinth Level Certificate','/application/plinth-level-certificate/update-inspection',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Update Inspection For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
(nextval('seq_eg_appconfig'),'PL_INSPECTION_SCHEDULE_INTEGRATION_REQUIRED','To enable/disable site inspection scheduling plinth level certificate application integration',0,NULL,NULL,NULL,NULL,(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_action (id,"name",url,queryparams,parentmodule,ordernumber,displayname,enabled,contextroot,"version",createdby,createddate,lastmodifiedby,lastmodifieddate,application) VALUES 
(nextval('seq_eg_action'),'Rejection For Plinth Level Certificate','/application/plinth-level-certificate/rejectionnotice',NULL,(select id from chandigarh.eg_module where name = 'BPA Plinth Level Certificate'),46,'Rejection For Plinth Level Certificate',false,'bpa',0,1,now(),1,now(),(select id from chandigarh.eg_module where "name" = 'BPA'))
;
...
INSERT INTO chandigarh.eg_appconfig (id,key_name,description,"version",createdby,lastmodifiedby,createddate,lastmodifieddate,"module") VALUES 
(nextval('seq_eg_appconfig'),'SLA_PL_APPLICATION','Sla PL Application',0,NULL,NULL,NULL,NULL,(select id from chandigarh.eg_module where "name" = 'BPA'))
;
