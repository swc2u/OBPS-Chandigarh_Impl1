...
delete from chandigarh.egbpa_checklist_servicetype_mapping where checklist in (select id from chandigarh.eg_checklist 
where checklisttypeid in (select id from chandigarh.eg_checklist_type where code in ('OCDCRDOCUMENTS')) and code in ('OCDCRDOC-05','OCDCRDOC-06'));

delete from chandigarh.eg_checklist 
where checklisttypeid in (select id from chandigarh.eg_checklist_type where code in ('OCDCRDOCUMENTS'))
and code in ('OCDCRDOC-05','OCDCRDOC-06');

delete from chandigarh.egbpa_checklist_servicetype_mapping where checklist in (select id from chandigarh.eg_checklist 
where checklisttypeid in (select id from chandigarh.eg_checklist_type where code in ('OCGENERALDOCUMENTS')));

update chandigarh.eg_checklist set description='Form-D' where code='OCDCRDOC-01' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCDCRDOCUMENTS');
update chandigarh.eg_checklist set description='Form-E' where code='OCDCRDOC-02' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCDCRDOCUMENTS');
update chandigarh.eg_checklist set description='Form-I' where code='OCDCRDOC-03' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCDCRDOCUMENTS');
update chandigarh.eg_checklist set description='Form-K' where code='OCDCRDOC-04' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCDCRDOCUMENTS');

update chandigarh.egbpa_checklist_servicetype_mapping set ismandatory=true, isrequired=true where checklist in (select id from chandigarh.eg_checklist where checklisttypeid in (select id from chandigarh.eg_checklist_type where code in ('OCDCRDOCUMENTS'))) and servicetype in (select id from chandigarh.egbpa_mstr_servicetype where code in ('01','03','04','06','07'));

update chandigarh.eg_checklist set description='Proof of ownership i.e. copy of allotment letter / transfer letter not more than 3 months old.' where code='OCGENERALDOC-01' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='No dues certificate with regard to payment of entire/full amount of premium of plot (including up to date annual Ground Rent / Lease Money (Self Attested)' where code='OCGENERALDOC-02' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Self attested undertaking:- a) Regarding ownership from owner(s) / applicant(s) with specimen signature, latest photographs and ID proof. b) That there is no dispute / litigation is pending in any court of law and the properties free from all sorts of encumbrance and there is no stay / restraining order from any court of law with regard to grant of occupation certificate.' where code='OCGENERALDOC-03' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Copy of Sewerage Connection / Occupation Certificate or extension in time limit for construction of the building.' where code='OCGENERALDOC-04' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='In case, sewerage connection/occupation certificate is not issued/obtained then furnish: - a) An attested copy of proof of construction i.e., water/electricity bills (prior to 22-1-1993 or construction of building within the stipulated period as per terms and conditions of allotment or within the extended period as the case may be), supported with a certificate issued by the Registered Architect on his/her letter head certifying that the building is constructed as per sanctioned plan and there is no building violations at Site/House. b) Certificate from the concerned water/electricity department certifying there in the date and year of release of permanent / regular water/electricity connection against the house/building in question.' where code='OCGENERALDOC-05' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='If applicant is GPA / SPA holder, then furnish:- a) Copy of GPA / SPA (attested by notary public). b) Affidavit regarding validity of GPA / SPA' where code='OCGENERALDOC-06' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Attested Copy of partnership deed, authorization letter in favor of the authorized signatory/ partner to apply for occupation certificate. (Applicable in case of property owned by Partnership Firm).' where code='OCGENERALDOC-07' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Attested copy of Memorandum of Articles and Association copy of resolution in favor of authorized signatory/ Director of the Company to apply for occupation certificate. (Application in case of property owned by the Company).' where code='OCGENERALDOC-08' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Photographs of elevation of front, rear and side elevation and internal showing that building is complete in all respect.' where code='OCGENERALDOC-09' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='CD / DVD are required where showing photographs of elevation of front, rear and side elevation.' where code='OCGENERALDOC-10' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Certificate from Architect for Rain water harvesting system as per building bye-laws.' where code='OCGENERALDOC-11' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Certificate from company with regard to installation of Solar Water heating system as per building bye-laws.' where code='OCGENERALDOC-12' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Certificate from company with regard to installation of Solar Photo-voltaic power plant as per building bye-laws.' where code='OCGENERALDOC-13' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='PLAN INSPECTION is required from CFO (Chief Fire Officer) as per Fire Department, Municipal Corporation, UT, Chandigarh.' where code='OCGENERALDOC-14' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='PLAN INSPECTION is required from Pollution Control Board as per Fire Department, Municipal Corporation, UT, Chandigarh.' where code='OCGENERALDOC-15' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

update chandigarh.eg_checklist set description='Copy of permission of amalgamation obtained from competent authority is required for amalgamated properties.' where code='OCGENERALDOC-16' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS');

INSERT INTO chandigarh.eg_checklist (id,checklisttypeid,code,description,"version",createdby,createddate,lastmodifiedby,lastmodifieddate) VALUES 
(nextval('seq_eg_checklist'),(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS'),'OCGENERALDOC-17','Agreement Deed is required for projections made on Govt. Land as per building bye-laws, if not submitted during Revised Building Plan.',0,1,now(),1,now())
,(nextval('seq_eg_checklist'),(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS'),'OCGENERALDOC-18','An undertaking from the Architect that there is no non-sanctionable & zoning violation(s) exist at site & the building violation and the sanctionable violation(s) have duly been marked on the completion plan.',0,1,now(),1,now())
,(nextval('seq_eg_checklist'),(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS'),'OCGENERALDOC-19','Completion drawing duly signed by the architect & owner (s) and duly laminated.',0,1,now(),1,now())
,(nextval('seq_eg_checklist'),(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS'),'OCGENERALDOC-20','Structural drawing duly signed by the owner (s), also stamped and signed by structural engineer and duly laminated.',0,1,now(),1,now());

INSERT INTO chandigarh.egbpa_checklist_servicetype_mapping (id,checklist,servicetype,isrequired,ismandatory,"version",createdby,createddate,lastmodifiedby,lastmodifieddate) VALUES 
(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-01'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-02'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-03'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-04'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-05'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-06'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-07'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-08'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-09'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-10'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-11'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-12'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-13'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-14'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-15'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-16'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-17'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-18'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-19'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-20'),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-01'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-02'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-03'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-04'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-05'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-06'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-07'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-08'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-09'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-10'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-11'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-12'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-13'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-14'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-15'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-16'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-17'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-18'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-19'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-20'),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-01'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-02'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-03'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-04'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-05'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-06'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-07'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-08'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-09'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-10'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-11'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-12'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-13'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-14'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-15'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-16'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-17'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-18'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-19'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-20'),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-01'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-02'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-03'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-04'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-05'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-06'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-07'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-08'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-09'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-10'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-11'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-12'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-13'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-14'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-15'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-16'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-17'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-18'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-19'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-20'),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-01'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-02'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-03'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-04'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-05'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-06'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-07'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-08'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-09'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-10'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-11'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-12'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-13'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-14'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-15'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-16'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-17'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-18'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-19'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from eg_checklist where checklisttypeid = (select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code='OCGENERALDOC-20'),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
;

update chandigarh.egbpa_checklist_servicetype_mapping set ismandatory=true where checklist in (select id from chandigarh.eg_checklist where checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCGENERALDOCUMENTS') and code in ('OCGENERALDOC-01','OCGENERALDOC-02','OCGENERALDOC-03')) and servicetype in (select id from chandigarh.egbpa_mstr_servicetype where code in ('01','03','04','06','07'));

--------------------------------------------------------------------------------------------------------------------------------

delete from chandigarh.egbpa_checklist_servicetype_mapping
where checklist in (select id from chandigarh.eg_checklist 
					where checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')) 
and servicetype in (select id from chandigarh.egbpa_mstr_servicetype where code in ('01','03','04','06','07'));

INSERT INTO state.eg_role (id,"name",description,createddate,createdby,lastmodifiedby,lastmodifieddate,"version",internal) VALUES 
(nextval('state.seq_eg_role'),'BPA_AC_TAX_NOC_ROLE','Role for users who approve/provides a NOC from AC Tax department',now(),1,1,now(),0,false);

delete from chandigarh.eg_checklist 
where checklisttypeid in (select id from chandigarh.eg_checklist_type where code in ('OCNOC'))
and code in ('OCNOC-06','OCNOC-07','OCNOC-08','OCNOC-09','AAI OCNOC','NMA OCNOC');

SELECT setval('seq_eg_checklist', (SELECT max(id) FROM chandigarh.eg_checklist));

INSERT INTO chandigarh.eg_checklist (id,checklisttypeid,code,description,"version",createdby,createddate,lastmodifiedby,lastmodifieddate) VALUES 
(nextval('seq_eg_checklist'),(select id from chandigarh.eg_checklist_type where code='OCNOC'),'AC TAX NOC','AC Tax department',0,1,now(),1,now());

update chandigarh.eg_checklist set code='PAC NOC', description='Urban Planning Department (PAC)' where code='IDA OCNOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC');

update chandigarh.eg_checklist set code='POL CONTROL NOC', description='Pollution control Department' where code='MOEF OCNOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC');

update chandigarh.eg_checklist set code='FIRE NOC', description='Fire Services' where code='FIRE OCNOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC');

SELECT setval('seq_egbpa_checklist_servicetype_mapping', (SELECT max(id) FROM chandigarh.egbpa_checklist_servicetype_mapping));

INSERT INTO chandigarh.egbpa_checklist_servicetype_mapping (id,checklist,servicetype,isrequired,ismandatory,"version",createdby,createddate,lastmodifiedby,lastmodifieddate) VALUES 
(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'PAC NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'POL CONTROL NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'FIRE NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'AC TAX NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='01'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'PAC NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'POL CONTROL NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'FIRE NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'AC TAX NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='03'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'PAC NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'POL CONTROL NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'FIRE NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'AC TAX NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='04'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'PAC NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'POL CONTROL NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'FIRE NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'AC TAX NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='06'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'PAC NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'POL CONTROL NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'FIRE NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
,(nextval('seq_egbpa_checklist_servicetype_mapping'),(select id from chandigarh.eg_checklist where code = 'AC TAX NOC' and checklisttypeid=(select id from chandigarh.eg_checklist_type where code='OCNOC')),(select id from chandigarh.egbpa_mstr_servicetype where code='07'),true,false,0,1,now(),1,now())
;

INSERT INTO state.eg_user select nextval('state.seq_eg_user'),'state', NULL, NULL, NULL, 'en_IN', 'actaxnoc', '$2a$10$uheIOutTnD33x7CDqac1zOL8DMiuz7mWplToPgcf7oxAI9OzRKxmK', now(), NULL, NULL, NULL, now(), now(), 1, 1, true, 'AC Tax department', NULL, NULL, NULL, 'BUSINESS', 0, NULL, NULL, 'state' where not exists (select * from state.eg_user where username='actaxnoc');

update state.eg_user set mobilenumber='1112345680' where username = 'actaxnoc';
update state.eg_user set pwdexpirydate='2025-12-31 00:00:00' where username = 'actaxnoc';

INSERT into state.eg_userrole select (select id from state.eg_role where name = 'BPA_AC_TAX_NOC_ROLE'), (select id from state.eg_user where username ='actaxnoc') where not exists (SELECT * FROM state.eg_userrole WHERE roleid in (select id from state.eg_role where name = 'BPA_AC_TAX_NOC_ROLE'));

INSERT into state.eg_userrole select (select id from state.eg_role where name = 'BUSINESS'), (select id from state.eg_user where username ='actaxnoc');

delete from chandigarh.egbpa_master_nocconfiguration where applicationtype = 'OC';

INSERT INTO chandigarh.egbpa_master_nocconfiguration (id,department,applicationtype,integrationtype,integrationinitiation,sla,isdeemedapproval) VALUES 
(nextval('SEQ_EGBPA_MSTR_NOCCONFIG'),'PAC NOC','OC','INTERNAL','AUTO',15,false)
,(nextval('SEQ_EGBPA_MSTR_NOCCONFIG'),'FIRE NOC','OC','INTERNAL','AUTO',15,false)
,(nextval('SEQ_EGBPA_MSTR_NOCCONFIG'),'POL CONTROL NOC','OC','INTERNAL','AUTO',15,false)
,(nextval('SEQ_EGBPA_MSTR_NOCCONFIG'),'AC TAX NOC','OC','INTERNAL','AUTO',15,false);

delete from eg_wf_matrix where objecttype = 'OccupancyCertificate';
...
(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','NEW','','Occupancy certificate application creation pending','','High Risk','Registered','Forwarded to verify application documents','Building Assistant Urban','Registered','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Registered','Registered','Forwarded to verify application documents','','High Risk','Application documents verification in progress','Forwarded to review application documents','Junior Engineer Urban','Document Verification Completed','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Application documents verification in progress','Document Verification Completed','Forwarded to review application documents','','High Risk','Forward to Head Draftsman','Forwarded to Head Draftsman for review','Head Draftsman Urban','Application Reviewed','Forward,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Forward to Head Draftsman','Application Reviewed','Forwarded to Head Draftsman for review','','High Risk','NOC updation in progress','Forwarded to check NOC updation','SDO Building Urban','Document Reviewed','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','NOC updation in progress','Document Reviewed','Forwarded to check NOC updation','','High Risk','AEE Application Approval Pending','Forwarded to E- Assistant Estate Officer for Approval','Assistant Estate Officer','NOC Updated','Forward,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','AEE Application Approval Pending','NOC Updated','Forwarded to E- Assistant Estate Officer for Approval','','High Risk','Final Approval Process initiated','Approved with fee collection pending','Estate Officer','AEE Approval Completed','Forward,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Final Approval Process initiated','AEE Approval Completed','Approved with fee collection pending','','High Risk','Record Approved','Forwarded to generate Occupancy Certificate','SDO Building Urban','Approved','Approve,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Record Approved',NULL,'Forwarded to generate Occupancy Certificate','','High Risk','END','END','SDO Building Urban','Occupancy Certificate Issued to Applicant','Generate Occupancy Certificate',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
...
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Registered','Registered','Forwarded to verify application documents','','Low Risk','Application documents verification in progress','Forwarded to review application documents','Junior Engineer Urban','Document Verification Completed','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Application documents verification in progress','Document Verification Completed','Forwarded to review application documents','','Low Risk','Forward to Head Draftsman','Forwarded to Head Draftsman for review','Head Draftsman Urban','Application Reviewed','Forward,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Forward to Head Draftsman','Application Reviewed','Forwarded to Head Draftsman for review','','Low Risk','Forward to SDO Building','Forwarded to SDO Building for review','SDO Building Urban','Document Reviewed','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Forward to SDO Building','Document Reviewed','Forwarded to SDO Building for review','','Low Risk','AEE Application Approval Pending','Forwarded to E- Assistant Estate Officer for Approval','Assistant Estate Officer','Application Reviewed','Forward,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','AEE Application Approval Pending','NOC Updated','Forwarded to E- Assistant Estate Officer for Approval','','Low Risk','Final Approval Process initiated','Approved with fee collection pending','Estate Officer','AEE Approval Completed','Forward,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Final Approval Process initiated','AEE Approval Completed','Approved with fee collection pending','','Low Risk','Record Approved','Forwarded to generate Occupancy Certificate','SDO Building Urban','Approved','Approve,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Record Approved',NULL,'Forwarded to generate Occupancy Certificate','','Low Risk','END','END','SDO Building Urban','Occupancy Certificate Issued to Applicant','Generate Occupancy Certificate',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Rejected','','','','Low Risk','generate rejection notice','Application is rejected by approver','SDO Building Urban','Rejected','Generate Rejection Notice',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','LP Initiated','','','','Low Risk','LP Created','Letter To Party Reply Pending','SDO Building Urban','Letter To Party Created','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','LP Created','','','','Low Risk','LP Reply Received','Forward to LP Initiator pending','SDO Building Urban','Letter To Party Reply Received','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
;

INSERT INTO eg_wf_matrix (id,department,objecttype,currentstate,currentstatus,pendingactions,currentdesignation,additionalrule,nextstate,nextaction,nextdesignation,nextstatus,validactions,fromqty,toqty,fromdate,todate,"version",enablefields,forwardenabled,smsemailenabled,nextref,rejectenabled) VALUES
(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','NEW','','Occupancy certificate application creation pending','','High Risk','Registered','Forwarded to verify application documents','Draftsman','Registered','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Registered','Registered','Forwarded to verify application documents','','High Risk','Application documents verification in progress','Forwarded to review application documents','Junior Engineer Rural','Document Verification Completed','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Application documents verification in progress','Document Verification Completed','Forwarded to review application documents','','High Risk','NOC updation in progress','Forwarded to check NOC updation','SDO Building MC','Document Reviewed','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','NOC updation in progress','Document Reviewed','Forwarded to check NOC updation','','High Risk','Final Approval Process initiated','Approved with fee collection pending','SDO Building MC','NOC Updated','Forward,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Final Approval Process initiated','NOC Updated','Approved with fee collection pending','','High Risk','Record Approved','Forwarded to generate Occupancy Certificate','SDO Building MC','Approved','Approve,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Record Approved',NULL,'Forwarded to generate Occupancy Certificate','','High Risk','END','END','SDO Building MC','Occupancy Certificate Issued to Applicant','Generate Occupancy Certificate',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Rejected','','','','High Risk','generate rejection notice','Application is rejected by approver','SDO Building MC','Rejected','Generate Rejection Notice',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','LP Initiated','','','','High Risk','LP Created','Letter To Party Reply Pending','SDO Building MC','Letter To Party Created','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','LP Created','','','','High Risk','LP Reply Received','Forward to LP Initiator pending','SDO Building MC','Letter To Party Reply Received','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
;
...
(nextval('seq_egbpa_status'),'Document Reviewed','Document Reviewed','REGISTRATION',true,0,1,now(),NULL,now())
,(nextval('seq_egbpa_status'),'Application Reviewed','Application Reviewed','REGISTRATION',true,0,1,now(),NULL,now());
