...
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Record Approved',NULL,'Forwarded to generate Occupancy Certificate','','High Risk','END','END','SDO Building Urban','Order Issued to Applicant','Generate Occupancy Certificate',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
...
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Record Approved',NULL,'Forwarded to generate Occupancy Certificate','','Low Risk','END','END','SDO Building Urban','Order Issued to Applicant','Generate Occupancy Certificate',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
...
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','NEW','','Occupancy certificate application creation pending','','Medium Risk','Registered','Forwarded to verify application documents','Draftsman','Registered','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Registered','Registered','Forwarded to verify application documents','','Medium Risk','Application documents verification in progress','Forwarded to review application documents','Junior Engineer Rural','Document Verification Completed','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Application documents verification in progress','Document Verification Completed','Forwarded to review application documents','','Medium Risk','NOC updation in progress','Forwarded to check NOC updation','SDO Building MC','Document Reviewed','Forward',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','NOC updation in progress','Document Reviewed','Forwarded to check NOC updation','','Medium Risk','Final Approval Process initiated','Approved with fee collection pending','SDO Building MC','NOC Updated','Forward,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Final Approval Process initiated','NOC Updated','Approved with fee collection pending','','Medium Risk','Record Approved','Forwarded to generate Occupancy Certificate','SDO Building MC','Approved','Approve,Reject',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Record Approved',NULL,'Forwarded to generate Occupancy Certificate','','Medium Risk','END','END','SDO Building MC','Order Issued to Applicant','Generate Occupancy Certificate',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
,(nextval('seq_eg_wf_matrix'),'ANY','OccupancyCertificate','Rejected','','','','Medium Risk','generate rejection notice','Application is rejected by approver','SDO Building MC','Rejected','Generate Rejection Notice',NULL,NULL,'2019-01-01','2099-04-01',0,NULL,NULL,NULL,NULL,NULL)
