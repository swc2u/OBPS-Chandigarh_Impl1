$(document)
    .ready(
        function () {
			...
			var rootBoundry=$("#rootBoundry").val();
			var data;
			
			function graph(){
				$.ajax({
				  type: "POST",
				  url: "/edcr/reports/buildingplan-scrutinyreport/"+rootBoundry,
				  data: data,
				  success: function(data){
				  scrutinyBarChart(data.data);
				  },
				  dataType: "json"
				});
			...
			function prepareSerachQuery(args) {
                                 console.log("table");
				  					console.log(args);
                                    data= {
                    ...
                    .dataTable(
                        {
                            ...
                            ajax: {
                                ...
                                data: function(args){return prepareSerachQuery(args)},
