...
public class ReceiptRegisterApplicationForm extends DataTableSearchRequest {
    private Long id;
    @SafeHtml
    ...
    public ReceiptRegisterApplicationForm() {
        // for form binding
    }

    public ReceiptRegisterApplicationForm(BpaApplication application, String currentOwner, String pendingAction,
    ...
    public ReceiptRegisterApplicationForm(OccupancyCertificate occupancyCertificate, String currentOwner, String pendingAction,
            Boolean isFeeCollected) {
    ...
    public ReceiptRegisterApplicationForm(BpaApplication application, OccupancyCertificate occupancyCertificate) {
        setApplicationNumber(application.getApplicationNumber());
    ...
    public ReceiptRegisterApplicationForm(PermitRenewal renewal, String currentOwner, String pendingAction, Boolean feeCollector,
            Boolean isFeeCollected) {
        setId(renewal.getId());
    ...
    public ReceiptRegisterApplicationForm(OwnershipTransfer ownershipTransfer, String currentOwner, String pendingAction, Boolean feeCollector,
            Boolean isFeeCollected) {
