...
alter table egbpa_buildingdetail add column townplanningzone character varying(30);
alter table egbpa_buildingdetail add column crzzone character varying(30);