...
<s:form theme="simple" name="displayReportForm">
	...
	<input name="buttonBack" type="button" class="button" id="buttonBack" value="Back" onclick="window.location='${pageContext.request.contextPath}/reports/collectionSummaryHeadWiseUrban-criteria.action';" />
