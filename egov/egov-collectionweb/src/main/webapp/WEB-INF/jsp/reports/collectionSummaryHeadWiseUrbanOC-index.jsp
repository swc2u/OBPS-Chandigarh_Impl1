...
<s:form theme="simple" name="collectionSummaryForm"
	action="collectionSummaryHeadWiseUrbanOC-report.action">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
	        ...
	        <td class="bluebox"><s:select headerKey="ALL"
				...
				<td class="bluebox"><s:text
 							name="collectionReport.criteria.applicationtype" /></td> 
				<td class="bluebox"><s:select headerKey="-1"
 						headerValue="%{getText('collectionReport.application.all')}" 
 						name="applicationTypeId" id="applicationTypeId" cssClass="selectwk" list="dropdownData.applicationTypeList" 
 							value="%{applicationTypeId}" listKey="id" listValue="description"  /></td> 
		</tr>
<!-- 		<tr> -->
<!-- 					<td class="bluebox">&nbsp;</td> -->
<%-- 					<td class="bluebox"><s:text --%>
