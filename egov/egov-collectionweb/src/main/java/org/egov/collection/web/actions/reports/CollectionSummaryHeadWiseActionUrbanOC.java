 ...
 */
@ParentPackage("egov")
@Results({@Result(name = CollectionSummaryHeadWiseActionUrbanOC.INDEX, location = "collectionSummaryHeadWiseUrbanOC-index.jsp"),
        @Result(name = CollectionSummaryHeadWiseActionUrbanOC.REPORT, location = "collectionSummaryHeadWiseUrbanOC-report.jsp")})
public class CollectionSummaryHeadWiseActionUrbanOC extends ReportFormAction {
     ...
     * @return index
     */
    @Action(value = "/reports/collectionSummaryHeadWiseUrbanOC-criteria")
    ...
    @Override
    @Action(value = "/reports/collectionSummaryHeadWiseUrbanOC-report")
...
//         }
        if (getApplicationTypeId() != null && getApplicationTypeId() !=-1) {
            ...
            String applicationTypeName = applicationType.getDescription();
...
//        }
        ...
        setReportData(reportService.getCollectionSummaryReportForUrbanOC(getFromDate(), getToDate(), getPaymentMode(),
	...
	public void setAppTypeList(List<Long> appTypeList) {
