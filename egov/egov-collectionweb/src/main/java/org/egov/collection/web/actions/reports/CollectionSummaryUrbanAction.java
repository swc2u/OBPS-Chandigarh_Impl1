...
public class CollectionSummaryUrbanAction extends ReportFormAction {
    ...
    private List<Long> applicationTypeId = new ArrayList<>();
...
//        }
        ...
        setReportData(reportService.getCollectionSummaryReportForUrban(getFromDate(), getToDate(), getPaymentMode(), getSource(),
                getServiceId(), getServiceType(),rootBoundaryType));
	...
	public List<Long> getApplicationTypeId() {
		return applicationTypeId;
	}

	public void setApplicationTypeId(List<Long> applicationTypeId) {
