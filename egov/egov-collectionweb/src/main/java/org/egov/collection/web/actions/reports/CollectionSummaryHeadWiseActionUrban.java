 ...
 */
@ParentPackage("egov")
@Results({@Result(name = CollectionSummaryHeadWiseActionUrban.INDEX, location = "collectionSummaryHeadWiseUrban-index.jsp"),
        @Result(name = CollectionSummaryHeadWiseActionUrban.REPORT, location = "collectionSummaryHeadWiseUrban-report.jsp")})
public class CollectionSummaryHeadWiseActionUrban extends ReportFormAction {
     ...
     * @return index
     */
    @Action(value = "/reports/collectionSummaryHeadWiseUrban-criteria")
    ...
    @Override
    @Action(value = "/reports/collectionSummaryHeadWiseUrban-report")
...
//        }
        ...
        setReportData(reportService.getCollectionSummaryReportForUrban(getFromDate(), getToDate(), getPaymentMode(),
