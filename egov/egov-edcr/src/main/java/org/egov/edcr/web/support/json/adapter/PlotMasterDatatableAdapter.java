...
public class PlotMasterDatatableAdapter implements DataTableJsonAdapter<PlotMaster> {

    @Override
    public JsonElement serialize(DataTable<PlotMaster> plotMasterDataTable, Type type, JsonSerializationContext jsc) {
        List<PlotMaster> plotMasterData = plotMasterDataTable.getData();

        JsonArray plotMasterJsonData = new JsonArray();
        ...
        return enhance(plotMasterJsonData, plotMasterDataTable);
    }
}