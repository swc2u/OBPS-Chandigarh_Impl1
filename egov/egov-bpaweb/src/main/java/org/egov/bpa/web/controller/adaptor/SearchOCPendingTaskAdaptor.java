...
public class SearchOCPendingTaskAdaptor implements DataTableJsonAdapter<SearchPendingItemsForm>{
	...
	public JsonElement serialize(DataTable<SearchPendingItemsForm> baseRegisterResponse, final Type type,
        ...
        baseRegisterResult.forEach(baseForm -> {
            ...
            baseRegisterJson.addProperty("bpaApplicationType", baseForm.getBPAApplicationType());
