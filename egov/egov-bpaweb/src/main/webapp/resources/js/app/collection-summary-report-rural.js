 ...
 */
 ...
 $('#btnSearch').click(function() {
		...
		$('#collectionSummaryReportRural').find(':input', ':select', ':textarea').each(function() {
			if ($(this).val()) {
				isValid = true;
				return false;
			} else
 ...
 function callAjaxSearch() {
		var rrURL='/bpa/reports/collectionSummary/d/r';
		$('.collection-section-rural').removeClass('display-hide');
		$("#collectionSummaryRuralTable").dataTable({
		processing: true,
		serverSide: true,
		sort: true,
		filter: true,
        ...
        buttons: [{
            extend: 'pdf',
            title: 'Collection Summary Report For BPA Rural',
            filename: 'Collection_Summary_Report_BPA_RURAL',
