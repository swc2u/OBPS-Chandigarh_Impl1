 ...
 */
 ...
 $('#btnSearch').click(function() {
		var isValid = false;
		$('#receiptRegisterReportRural').find(':input', ':select', ':textarea').each(function() {
			if ($(this).val()) {
				isValid = true;
				return false;
			} else
 ...
 function callAjaxSearch() {
		var rrURL='/bpa/reports/receiptRegister/d/r';
		$('.receipt-report-rural').removeClass('display-hide');
		$("#searchReceiptRegisterRural").dataTable({
		processing: true,
		serverSide: true,
		sort: true,
		filter: true,
