...
jQuery(document).ready(function() {
    ...
    '<th class="text-center bldg-floor-toggle-mandatory">Builtup Area</th>'+
    '<th class="text-center bldg-floor-toggle-mandatory">Floor Area</th>'+
    '<th class="text-center bldg-floor-toggle-mandatory">Carpet Area</th>'+
