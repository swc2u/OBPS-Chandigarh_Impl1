 ...
 */
 ...
 $('#btnSearch').click(function() {
		...
		$('#collectionSummaryHeadwiseOCReport').find(':input', ':select', ':textarea').each(function() {
			if ($(this).val()) {
				isValid = true;
				return false;
			} else
 ...
 function callAjaxSearch() {
		var rrURL='/bpa/reports/collectionSummaryHeadwiseOC/d/u';
		$('.collection-headwise-oc-section').removeClass('display-hide');
		$("#collectionSummaryHeadwiseOCTable").dataTable({
		processing: true,
		serverSide: true,
		sort: true,
		filter: true,
        ...
        buttons: [{
            extend: 'pdf',
            title: 'Collection Summary Headwise Report For Occupancy Certificate Urban',
            filename: 'Collection_Summary_Headwise_Report_OC_URBAN',
