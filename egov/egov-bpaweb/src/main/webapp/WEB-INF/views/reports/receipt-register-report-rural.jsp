...
<form:form role="form" action=""
	modelAttribute="searchBpaApplicationForm" id="receiptRegisterReportRural" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
	<div class="col-md-12">
...
<div class="row display-hide receipt-report-rural" id="table_container">
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl nowrap display"
                       id="searchReceiptRegisterRural" style="overflow-x: auto;max-width: 100%;min-width: 100%;">
                    <thead>
                    <tr>
...
<script src="<cdn:url value='/resources/js/app/receipt-register-report-rural.js?rnd=${app_release_no}'/> "></script>
