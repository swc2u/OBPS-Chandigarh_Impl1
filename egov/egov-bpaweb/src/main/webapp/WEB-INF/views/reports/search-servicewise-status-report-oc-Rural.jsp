...
<form:form role="form" action=""
	modelAttribute="searchBpaApplicationForm" id="serviceTypeWiseStatusRuralOCReport" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
	<div class="col-md-12">
...
<div class="row display-hide ss-rural-oc-report-section" id="table_container">
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="searchStatusByServiceTypeReportRuralOCTable">
			<thead>
				<tr>
...
<script src="<cdn:url value='/resources/js/app/servicewise-status-report-helper-chart-oc-Rural.js?rnd=${app_release_no}'/> "></script>
