...
<form:form role="form" action=""
	modelAttribute="searchBpaApplicationForm" id="serviceTypeWiseStatusRuralPLReport" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
	<div class="col-md-12">
...
<div class="row display-hide ss-rural-pl-report-section" id="table_container">
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="searchStatusByServiceTypeReportRuralPLTable">
			<thead>
				<tr>
...
<script src="<cdn:url value='/resources/js/app/servicewise-status-report-helper-chart-pl-Rural.js?rnd=${app_release_no}'/> "></script>
