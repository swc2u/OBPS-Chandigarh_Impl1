...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value='/resources/global/css/bts/typeahead.css' context='/egi'/>">
		<link rel="stylesheet" href="<c:url value='/resources/global/css/font-icons/font-awesome/css/font-awesome.min.css' context='/egi'/>">
		<link rel="stylesheet" href="<c:url value='/resources/global/css/bts/bts-datepicker.css' context='/egi'/>">
		<link rel="stylesheet" href="<c:url value='/resources/global/css/egov/custom.css?rnd=${app_release_no}' context='/egi'/>">
		
		<script src="<c:url value='/resources/global/js/jq/jq.js' context='/egi'/>"></script>
		<script src="<c:url value='/resources/global/js/bts/bts.js' context='/egi'/>"></script>
		<script src="<c:url value='/resources/global/js/bts/bootbox.min.js' context='/egi'/>"></script>
		<script src="<c:url value='/resources/global/js/jq/plugins/jq.validate.min.js' context='/egi'/>"></script>
		<script src="<c:url value='/resources/global/js/bts/bts-datepicker.js' context='/egi'/>"></script>
		<script src="<c:url value='/resources/global/js/bts/typeahead.bundle.js' context='/egi'/>"></script>
		<script src="<c:url value='/resources/global/js/jq/plugins/jq.inputmask.bundle.min.js' context='/egi'/>"></script>
