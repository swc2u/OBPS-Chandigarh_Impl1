...
<form:form role="form" action="" modelAttribute="searchOCPendingItemsForm" id="searchOCUrbanItemsForm" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
	<div class="row">
	    <div class="col-md-12">
...
<script src="<cdn:url value='/resources/js/app/searchocitems-urban.js?rnd=${app_release_no}'/> "></script>
