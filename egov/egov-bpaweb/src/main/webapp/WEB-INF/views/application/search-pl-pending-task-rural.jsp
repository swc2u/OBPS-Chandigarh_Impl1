...
<form:form role="form" action="" modelAttribute="searchPLPendingItemsForm" id="searchPLRuralPendingItemsForm" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
	<div class="row">
	    <div class="col-md-12">
...
<div class="row display-hide pl-pending-task-report-section-rural" id="table_container">
	<div class="col-md-12 table-header text-left"><spring:message code="lbl.search.result" /></div>
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="search_pl_pending_rural_items_table">
			<thead>
				<tr>
...
<script src="<cdn:url value='/resources/js/app/searchplpendingitems-rural.js?rnd=${app_release_no}'/> "></script>
