...
<form:form role="form" action="" modelAttribute="searchOCPendingItemsForm" id="searchOCPendingItemsForm" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
	<div class="row">
	    <div class="col-md-12">
...
<div class="row display-hide report-section" id="table_container">
	...
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="search_oc_pending_items_table">
			<thead>
				<tr>
...
<script src="<cdn:url value='/resources/js/app/searchpendingocitems-urban.js?rnd=${app_release_no}'/> "></script>
