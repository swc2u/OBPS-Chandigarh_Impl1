...
<form:form role="form" action="" modelAttribute="searchPLPendingItemsForm" id="searchPLRuralItemsForm" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
	<div class="row">
	    <div class="col-md-12">
...
<script src="<cdn:url value='/resources/js/app/searchplitems-rural.js?rnd=${app_release_no}'/> "></script>
