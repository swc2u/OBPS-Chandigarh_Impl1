			...
			`	<table>
					<tr>
						<c:if
							...
							<td><a
								href="/bpa/application/occupancy-certificate/generate-occupancy-certificate/${plinthLevelCertificate.applicationNumber}"
								target="popup" class="btn btn-primary"
								onclick="window.open('/bpa/application/occupancy-certificate/generate-occupancy-certificate/${plinthLevelCertificate.applicationNumber}','popup','width=1100,height=700'); return false;">
									Print Occupancy Certificate </a>&nbsp;</td>
						</c:if>
						<c:if
							test="${plinthLevelCertificate.status.code eq 'Cancelled' && occupancyCertificate.state ne null}">
							<td><a
								href="/bpa/application/occupancy-certificate/rejectionnotice/${plinthLevelCertificate.applicationNumber}"
								target="popup" class="btn btn-primary"
								onclick="window.open('/bpa/application/occupancy-certificate/rejectionnotice/${plinthLevelCertificate.applicationNumber}','popup','width=1100,height=700'); return false;">
