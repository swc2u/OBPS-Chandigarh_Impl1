...
<div class="row">
	<div class="col-md-12">
		<form:form role="form" action="" method="post"
			modelAttribute="plInspection" id="plInspectionform"
			cssClass="form-horizontal form-groups-bordered"
			enctype="multipart/form-data">

			<input type="hidden" id="id" name="id" value="${plInspection.id}" />
			<input type="hidden" id="plInspection" name="plInspection"
				value="${plInspection.id}" />
			<input type="hidden" id="plId" name="pl"
				value="${plInspection.pl.id}" />
			...
			<ul class="nav nav-tabs" id="settingstab">
				<li class="active"><a data-toggle="tab" href="#plinspn-details"
			...
			<div class="tab-content">
				<div id="plinspn-details" class="tab-pane fade in active">
