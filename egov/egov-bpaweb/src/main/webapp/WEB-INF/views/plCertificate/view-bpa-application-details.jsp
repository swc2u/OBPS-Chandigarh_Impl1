...
<div class="panel-body">
	<div class="row add-border">
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.pl.appln.no" />
		</div>
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${plinthLevelCertificate.applicationNumber}" default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.pl.appln.date" />
		</div>
		<div class="col-sm-3 add-margin view-content text-justify">
			<fmt:formatDate value="${plinthLevelCertificate.applicationDate}" pattern="dd/MM/yyyy" var="plAapplicationDate" />
			<c:out value="${plAapplicationDate}" default="N/A"></c:out>
		</div>
	</div>
	<c:if
	...
	<div class="row add-border">
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.pl.contst.start.date" />
		</div>
		<div class="col-sm-3 add-margin view-content text-justify">
			<fmt:formatDate value="${plinthLevelCertificate.commencedDate}" pattern="dd/MM/yyyy" var="plCommencedDate" />
			<c:out value="${plCommencedDate}" default="N/A"></c:out>
		</div>
	</div>
	<div class="row add-border">
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.pl.contst.reached.to.pl" />
		</div>
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${plinthLevelCertificate.isConstructionReachedToPL ? 'YES' : 'NO'}"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.pl.contst.done" />
		</div>
		<div class="col-sm-3 add-margin view-content text-justify">
			<c:out value="${plinthLevelCertificate.isConstructionDone ? 'YES' : 'NO'}"></c:out>
		</div>
	</div>
</div>
