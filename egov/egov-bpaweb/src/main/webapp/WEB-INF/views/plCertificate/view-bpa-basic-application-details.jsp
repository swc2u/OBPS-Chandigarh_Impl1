...
<div class="panel-body display-hide">
	<div class="row add-border">
	  ...
	  <c:choose>
			...
			<div class="col-sm-3 add-margin view-content">
				<a target="popup" onclick="window.open('/bpa/application/details-view/by-permit-number/${plinthLevelCertificate.parent.planPermissionNumber}','popup','width=1100,height=700'); return false;"
				>${plinthLevelCertificate.parent.planPermissionNumber}</a>
			</div>
			</c:otherwise>
		</c:choose>
	...
	<c:choose>
			...
			<c:otherwise>
					...
					<div class="col-sm-3 add-margin view-content">
						<c:out value="${plinthLevelCertificate.parent.owner.name}" default="N/A"></c:out>
					</div>
					<div class="col-sm-3 add-margin">
						<spring:message code="lbl.owner.address"/>
					</div>
					<div class="col-sm-3 add-margin view-content">
						<c:out value="${plinthLevelCertificate.parent.owner.address}"></c:out>
					</div>
			</c:otherwise>
		</c:choose>
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${plinthLevelCertificate.parent.stakeHolder[0].stakeHolder.stakeHolderType.name}" default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.stakeholder.name"/>
		</div>
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${plinthLevelCertificate.parent.stakeHolder[0].stakeHolder.name}"></c:out>
		</div>
	</div>
	<div class="row add-border">
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${plinthLevelCertificate.parent.occupanciesName}" default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.build.plan.permission.date"/>
		</div>
		<div class="col-sm-3 add-margin view-content">
            <fmt:formatDate value="${plinthLevelCertificate.parent.planPermissionDate}" pattern="dd/MM/yyyy" var="planPermissionDate" />
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${plinthLevelCertificate.parent.serviceType.description}" default="N/A"></c:out>
		</div>
	</div>
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${plinthLevelCertificate.parent.siteDetail[0].reSurveyNumber}" default="N/A"></c:out>
		</div>
	</div>
</div>
