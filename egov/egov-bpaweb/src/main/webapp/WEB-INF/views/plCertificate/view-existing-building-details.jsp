...
<div class="panel-body display-hide">
    <c:if test="${not empty plinthLevelCertificate.parent.existingBuildingDetails}">
        <c:forEach
                items="${plinthLevelCertificate.parent.existingBuildingDetails}"
            ...
            <c:if
                ...
                <div class="panel-heading custom_form_panel_heading toggle-bldg-header toggle-head${existBldgCounter.index}"
                    ...
                    <div class="panel-title">
                        <c:if test="${fn:length(plinthLevelCertificate.parent.existingBuildingDetails) gt 1}">Block - ${existBldg.name}</c:if>
                        <spring:message code="lbl.plint.carpet.details"/>
                    </div>
                    <c:if test="${fn:length(plinthLevelCertificate.parent.existingBuildingDetails) gt 1}">
                ...
                <div <c:if
                             test="${fn:length(plinthLevelCertificate.parent.existingBuildingDetails) gt 1}">class="buildingDetailsToggle${existBldgCounter.index} display-hide" </c:if>>
                    <table class="table table-striped table-bordered"
                        ...
                        <c:forEach
                            ...
                            <input type="hidden" value="${floorDetails.id}"
                                   ...
                                   name="plinthLevelCertificate.parent.existingBuildingDetails[0].existingBuildingFloorDetails[${counter.index}].id"/>
