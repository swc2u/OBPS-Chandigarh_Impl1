...
<div class="panel-body">
    <table class="table table-bordered  multiheadertbl">
        ...
        <tbody>
        <c:choose>
            <c:when test="${not empty  plinthLevelCertificate.parent.getPermitDcrDocuments()}">
                <c:forEach items="${plinthLevelCertificate.parent.getPermitDcrDocuments()}" var="permitDcr"
                           varStatus="dcrStatus">
                    <tr>
